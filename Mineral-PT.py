...
def main():
    ...
    gui.geometry('+5+5')
    iconpath = resource_path("minpt.ico")
    ...
    # ptable Frame
    ptableFrame = LabelFrame(gui, width = 200, height = 10, pady = 4, padx = 4, fg = "#545454", font = consolas10, text = "Select Elements")
    ptableFrame.grid(row=1, column=1, columnspan=1, pady = [4,2], padx = 4, sticky= NSEW)
    ...
    mineralTableFrame = LabelFrame(gui, width = 200, height = 10, pady = 4, padx = 4, fg = "#545454", font = consolas10, text = mineralTableStatus.get())
    mineralTableFrame.grid(row=2, column=1, columnspan=1, pady = [2,0], padx = 4, sticky= NSEW)
